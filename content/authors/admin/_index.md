...
In my role as a Structural Design Engineer, I contribute to the development and advancement of aerospace technologies, ensuring that aircraft are not only structurally sound but also optimized for performance and safety. This hands-on experience in aerospace engineering has provided me with valuable insights into the intricate world of robotics and autonomous systems.

My studies at the National University of Sciences and Technology are aimed at deepening my knowledge in robotics and control systems, allowing me to bridge the gap between theory and practical applications in the field. I am dedicated to exploring innovative solutions that can enhance the capabilities of aerial robotics and enable effective multi-agent control in various applications, ranging from search and rescue missions to precision agriculture.

I am enthusiastic about the synergy between my engineering background and my academic pursuits, as I believe it equips me to contribute to the development of autonomous systems that have a meaningful impact on our society. I look forward to furthering my research and collaborating with like-minded individuals and organizations to shape the future of autonomous technologies.
